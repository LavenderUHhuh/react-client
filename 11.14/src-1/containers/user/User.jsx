...
import { getUsers, getRoles, addUser, updateUser, deleteUser } from '../../redux/ation-creators'
@connect(state => ({ users: state.users, roles: state.roles }), { getUsers, getRoles, addUser, updateUser, deleteUser })
